...
dex_list = {"Uniswap V2":"Uniswap V2","Curve pool":"Curve.fi sUSD,Curve.fi 3pool","Curve yearn":"Curve.fi,Curve.fi v2,Curve.fi iearn,Curve.fi BUSD,Curve.fi PAX","Balancer":"Balancer","Swerve":"Swerve.fi","Black Hole Swap":"Black Hole Swap","Mooniswap":"Mooniswap","Sushi Swap":"Sushi Swap","Pathfinder":"Pathfinder","Oasis":"Oasis","Uniswap":"Uniswap","Kyber":"Kyber","Bancor":"Bancor","PMM2":"PMM2","0x Relays":"0x Relays", "PMM":"PMM", "AirSwap":"AirSwap", "DODO":"DODO", "dForce Swap":"dForce Swap", "mStable":"mStable"}
...
def get_coin_amount(from_coin, to_coin, amount, dex_valid=["Uniswap V2","Curve pool","Swerve"], DEBUG=False):
    dex_used = {}
    to_amount = 0
...
def best_dex(from_coin, to_coin, amount, dex_valid = ["Uniswap V2","Curve pool","Swerve"]):
    best_amount = 0
    a_dex_used = "None"
    ...
    binance_amount = math.floor(binanceapi.Binance(from_coin,to_coin,amount/n18)*n18)
    if best_amount > binance_amount:
        return {"to_amount":best_amount, "dex_used":a_dex_used}
    else:
        return {"to_amount":binance_amount, "dex_used":"Binance"}

    

if __name__ == '__main__':
    print(best_dex("USDT","BUSD",n18*10000,["Curve pool"]))
